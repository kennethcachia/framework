define([
  ...
  describe('Controller', function () {
    ...
    beforeEach(function () {
      ...
      C.prototype._updateRenderable = function (context) {
        return {
          name: context.name
        };
      };
    ...
    it('should not re-render itself when the context changes', function () {
      expect(fixture.innerHTML).toEqual('<div>hello</div>');
    ...
    it('should update any other controllers that share the same context', function () {
      ...
      c.updateContext('name', 'bye bye');

      expect(fixture.innerHTML).toEqual('<div>bye</div>');
      expect(fixture2.innerHTML).toEqual('<div>bye bye</div>');
