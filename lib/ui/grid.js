...
define([
  ...
  Grid.prototype.template =
    '{{#@}}' +
      '<div class="ui-grid-item">' +
        '<div class="ui-grid-item-intrinsic">' +
          '<div class="ui-grid-item-intrinsic-content">' +
            '{{#embed}}{{{embed-content}}}{{/embed}}' +
          '</div>' +
          '<div class="ui-grid-item-intrinsic-cover"></div>' +
        '</div>' +
      '</div>' +
    '{{/@}}';
  ...
  Grid.prototype.bindEvents = function () {
    ...
    this.onDOMEvent(
      'click', this._selectItem, this, '.ui-grid-item-intrinsic-cover');
  };
