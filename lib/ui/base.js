...
define([
...
], function (Controller, inherit, TemplateRenderer, Properties, Check) {
   ...
   */
  var UIBase = function (domNode, template, context, key, properties) {
    ...
    UIBase.superClass.call(this, this.renderer, context, key, properties);
