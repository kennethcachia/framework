...
define([
   ...
   *        The name of the event that will trigger a context update.
   */
  var InputBase = function (eventName, context, key) {
  ...
  InputBase.prototype.bindEvents = function () {
    ...
    this.onDOMEvent(this._eventName, this._onChange, this);
  };
