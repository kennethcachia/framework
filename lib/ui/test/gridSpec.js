define([
  ...
  describe('Grid', function () {
    ...
    it('should embed content when a content key is specified', function () {
      ...
      grid.attach(d);
      expect(d._node.innerHTML).toEqual(
        '<div class="ui-grid-item"><div class="ui-grid-item-intrinsic">1</div></div>' +
        '<div class="ui-grid-item"><div class="ui-grid-item-intrinsic">2</div></div>' +
        '<div class="ui-grid-item"><div class="ui-grid-item-intrinsic">3</div></div>');
    });
    ...
    it('should fire an event when an item is selected', function () {
      ...
      var first = fixture.querySelector('.ui-grid-item .ui-grid-item-intrinsic');
      var last = fixture.querySelector('.ui-grid-item:last-of-type .ui-grid-item-intrinsic');
