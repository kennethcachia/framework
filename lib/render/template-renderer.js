...
define([
  ...
  /**
   * Scans the template for tokens.
   *
   * @method
   * @private
   */
  TemplateRenderer.prototype._scanForTokens = function () {
    this._tokens = {};
    this._findTokens(Mustache.parse(this._template));
  };


  /**
   * Recursively finds all the tokens used by the template.
   * 
   * @method
   * @private
   */
  TemplateRenderer.prototype._findTokens = function (list) {
