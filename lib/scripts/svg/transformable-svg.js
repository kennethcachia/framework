...
define([
  ...
  'lib/base/create',
  'lib/svg/svg',
  'lib/svg/transformable-svg-bounding-box',
  'lib/dom/dom-element',
  'lib/core/object-array'

], function (Create, SVGView, SVGTransformableBoundingBox, DOMElement, ObjectArray) {
  ...
  var TransformableSVGView = Create('TransformableSVGView', {
    ...
    bindEvents: function () {
      ...
      this._events.addObject(container.addDOMEvent({
        eventName: 'mousedown',
