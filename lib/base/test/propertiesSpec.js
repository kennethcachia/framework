define(['lib/base/properties'], function (Properties) {
  ...
  describe('Mutable Properties', function () {
    ...
    beforeEach(function () {
      A = function () {};
      Properties.defineMutableProperty(A, 'prop1', 10);
      a = new A();
    });
  ...
  describe('Immutable Properties', function () {
    ...
    beforeEach(function () {
      A = function () {};
      Properties.defineImmutableProperty(A, 'prop1', 10);
      a = new A();
    });
    ...
    it('should throw an error if an initial value is not defined', function () {
      ...
      expect(function () {
        Properties.defineImmutableProperty(B, 'prop1');
      }).toThrowError();
    });
  ...
  describe('Immutable Accessors', function () {
    ...
    beforeEach(function () {
      ...
      Properties.defineImmutableAccessor(A, 'prop1', 1, getter);
  ...
  describe('Mutable Accessors', function () {
    ...
    beforeEach(function () {
      ...
      Properties.defineMutableAccessor(A, 'prop1', 1, function (val) {
        return val;
      }, function (val) {
        return val;
      });
    ...
    it('should allow computed values', function () {
      Properties.defineMutableAccessor(A, 'prop2', 1, function (val) {
        return val + 1;
      }, function (val) {
        return val + 10;
      });
